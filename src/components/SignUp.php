            ...
            <form class="space-y-4" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST">
                <div>
                    ...
                    <input type="text" name="name" placeholder="Name"
                        class="<?php echo $name ? " border-red-500" : "border border-black" ?> w-full border rounded-md p-2 outline-none">
                </div>
                <div>
                    <label class="block text-gray-700">Email</label>
                    <input type="email" name="email" placeholder="Email"
                        class="<?php echo $email ? "border-red-500" : "border border-black" ?> w-full border rounded-md p-2 outline-none">
                </div>
                <div>
                    <label class="block text-gray-700">Password</label>
                    <input type="password" name="password" placeholder="Password"
                        class="<?php echo $password ? "border-red-500" : "border border-black" ?> w-full border rounded-md p-2 outline-none">
                </div>
