...
<?php if (isset($success)): ?>
    <div id="successToast" class="fixed top-4 right-4 py-10 px-8 bg-green-50 rounded-lg shadow-lg transition-opacity duration-500">
...
<?php if (isset($err)): ?>
    <div id="errorToast" class="fixed top-4 right-4 py-10 px-8  bg-red-50 rounded-lg shadow-lg transition-opacity duration-500">
